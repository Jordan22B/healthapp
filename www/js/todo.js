...
$('.credit-list').html('<div class="list-heading"><a class="avatar-50" href="#" target="_blank"><span class="ova"></span><img src="#" ></a></div><div class="about-me"></div><ul><li><a href=#" target="_blank"></a></li><li><a href="#">Rate the app</a></li><li><a href="#">Terms of use</a></li><li><a href="#">FAQ</a></li><li><a id="collapse" href="#">Collapse The bar</a></li></ul>');
